...
import { ArrowRight, Code2, Rocket, Briefcase, Calendar, MapPin, User, CheckCircle2, Download, Presentation, X } from "lucide-react";

const PPT_EMBED_URL = "https://docs.google.com/presentation/d/1UsLVsUqcZrg9fD3qS_3kYK1ZpnDq9Lv8/edit?usp=drive_link&ouid=116936924506428949760&rtpof=true&sd=true";
        ...
        <main className="min-h-screen bg-background flex flex-col">
            ...
            <section className="pt-28 md:pt-40 pb-20 px-6 md:px-12 xl:px-24 max-w-7xl mx-auto w-full">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-12">
                    <a
                        href="/ppt/Stage BXTTERFLY - BTS SIO SLAM.pptx"
                        download
                ...
                {showPpt && (
                    <div className="mb-12 w-full rounded-2xl overflow-hidden border border-glass-border bg-white/5">
                        <iframe
                            ...
                            frameBorder="0"
                            allowFullScreen
                            title="Présentation Stage BXTTERFLY"
                            className="w-full"
                        />
                    </div>
                )}
